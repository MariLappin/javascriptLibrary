...
2) multi-line comments
  */
  ...
  //consol.log and debugging
  //we can debug with consol.log messages in 2 big ways:
  //1) we can check the status of some javascript 'thing'
  //2) we can check a process we have built with repeated conole.log messages
